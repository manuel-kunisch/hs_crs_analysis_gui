...
- you want to confirm that TIFF loading, spectral-axis detection, ROIs, seeds, the NNMF/NNLS analysis modes (see [Concepts](../concepts.md)), and export all work end-to-end,
