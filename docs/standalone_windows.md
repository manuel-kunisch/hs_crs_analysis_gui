...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\build_windows_cpu.ps1 -Version 0.9.2
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\build_windows_pytorch.ps1 -TorchIndexUrl https://download.pytorch.org/whl/cu124 -RequireCuda -Version 0.9.2
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\build_windows_pytorch.ps1 -SkipInstall -RequireCuda -PythonExeOverride C:\path\to\env\python.exe -TorchIndexUrl https://download.pytorch.org/whl/cu124 -Version 0.9.2
```
...
```powershell
.\dist\HS_MOSAIC_GPU_CUDA124_v0.9.2\HS_MOSAIC.exe --backend-self-test $env:TEMP\hs_backend_selftest.json
